...
$messages['en'] = array(
	...
	'od-nospec-form' => 'There is no specification yet, you can create one after submitting this form. This should lead to a complete set of Key Issues (Milestones).',

...
$messages['en'] = array(
	...
	'od-task-status-list-info' => 'This is the list of different states that a task in the organisation can be in at any particular time. To change the options available in this list click [{{fullurl:MediaWiki:od-task-status-list|action=edit}} here]',

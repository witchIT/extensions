<?php
/**
 * Andreas G. Papandreou Foundation wiki skin
 *
 ...
 * @addtogroup Skins
 */
class SkinAGP extends SkinTemplate {
 ...
 * @addtogroup Skins
 */
class AGPTemplate extends QuickTemplate {
	/**
...
<div id="CenterPageOuter">
	<div id="CenterPage">
		<div id="LogoArea">
			...
			<div class="header-<?php echo $this->text('pageclass') ?>"></div>
		</div>

...
if ( $wgOrganicDesignDonations ) {?>
	<div class="portlet" id="donations" >
		...
		<div class="pBody" style="white-space:nowrap;vertical-align:top;background:url(/files/a/a0/Bitcoin-icon.png) no-repeat 5px 1px;">
			<input style="width:135px;margin-left:23px" value="1PVoayGWHbShwM6m5r2qACURBMMfTmR5jT" onmouseover="this.select()" />
		</div>
	</div>
<?php }?>

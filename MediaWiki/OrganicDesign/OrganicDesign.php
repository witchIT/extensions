...
class OrganicDesign {
	...
	public static function social( $out ) {
		...
		$social .= '<a href="https://www.organicdesign.co.nz/wiki/api.php?action=blikifeed"><img src="/files/6/6d/Rss_32.png" alt="RSS" /></a>';
		$social .= '<a href="https://www.organicdesign.co.nz/contact"><img src="/files/e/e6/Email_32.png" alt="Email" /></a>';
		$social .= '</div>';
		$out->addHTML( $social );
	}

...
$messages['en'] = array(
	...
	'see-donations' => "See [[donations]] for more payment options",
	'checkout' => "Checkout",
	'also' => "So is",
	'homepage' => "Home",
	'news' => "News",
...
***{{RecentActivity:type=new|count=10|format=***}}
{{#ifgroup:user|
**[[RecentActivity|My Recently Edited Articles]]
***{{RecentActivity:type=edits|count=10|user={{CURRENTUSER}}|format=***}}
}}
*'''Toolbox'''
...
$messages['pt'] = array(
	...
	'see-donations' => "Veja [[Donations|doações]] para mais opções de pagamento",
	'also' => "Também",
	'checkout' => "Caixa",

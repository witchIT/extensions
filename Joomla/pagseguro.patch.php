...
class plgVmPaymentPagseguro extends vmPSPlugin
{
	...
	private function _addRequiredClasses()
	{
		if (!class_exists('VirtueMartModelOrders')) {
			require(JPATH_VM_ADMINISTRATOR . DS . 'components' . DS . 'virtuemart' . DS . 'models' . DS . 'orders.php');
		}

		if (!class_exists('VirtueMartModelCurrency')) {
			require(JPATH_VM_ADMINISTRATOR . DS . 'components' . DS . 'virtuemart' . DS . 'models' . DS . 'currency.php');
		}

		if (!class_exists('TableVendors')) {
			require(JPATH_VM_ADMINISTRATOR . DS . 'components' . DS . 'virtuemart' . DS . 'tables' . DS . 'vendors.php');
		}

		if (!class_exists('VirtueMartCart')) {
			require(JPATH_VM_SITE . DS . 'components' . DS . 'virtuemart' . DS . 'helpers' . DS . 'cart.php');
		}
